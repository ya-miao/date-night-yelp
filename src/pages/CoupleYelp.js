...
const CoupleYelp = ({ callYelpApi, winerResuaurant, suggestionRestaurants, setCategories, setMaxDistanceOne, setPriceLevelOne, setMaxDistanceTwo, setPriceLevelTwo, location }) => {
  const signOut = async () => {
    try {
      await Auth.signOut();
    } catch (error) {
